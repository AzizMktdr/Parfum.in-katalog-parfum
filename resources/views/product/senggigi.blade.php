@extends('layouts.app')
@section('title', 'Senggigi — Mandalika — Parfum.in')
@section('content')
...
<div class="detail-breadcrumb">
    ...
    <span>›</span>
    <span>Mandalika Senggigi</span>
</div>

<div class="detail-page">
    <p class="detail-brand-label">Mandalika</p>
    <h1 class="detail-name-center">Senggigi</h1>
    ...
    <div class="detail-main-grid">
        ...
        <div class="detail-image-wrap">
            ...
            <img src="{{ asset('images/products/invade.png') }}" alt="Senggigi" onerror="this.style.opacity='0.15'">
        </div>
        ...
        <div class="detail-info">
            ...
            <div class="detail-info-row">
                ...
                <div class="detail-notes-list"><span>Marine</span><span>Bergamot</span><span>Grapefruit</span></div>
            </div>
            <div class="detail-info-row">
                <div class="detail-info-label">Middle Notes</div>
                <div class="detail-notes-list"><span>Cedarwood</span><span>Vetiver</span><span>Geranium</span></div>
            </div>
            <div class="detail-info-row">
                <div class="detail-info-label">Base Notes</div>
                <div class="detail-notes-list"><span>Sandalwood</span><span>Amber</span><span>Musk</span></div>
            </div>
        </div>
    </div>
    ...
    <div class="detail-purchase-row">
        <div class="detail-purchase-left">
            <div class="detail-thumb">
                <img src="{{ asset('images/products/invade.png') }}" alt="Senggigi" onerror="this.style.opacity='0'">
            </div>
            <div>
                <div class="detail-purchase-name">Senggigi</div>
                <div class="detail-purchase-type">Eau De Parfum | 50ml</div>
                <div class="detail-price">Rp140.000</div>
            </div>
        </div>
        <div class="detail-purchase-right">
            <div class="detail-stars">★★★★☆</div>
            <span class="detail-rating-score">4.5</span>
            <span class="detail-review-count">41 review</span>
        </div>
    </div>
    ...
    <div class="detail-desc-section">
        ...
        <p class="detail-desc-subtitle">Mandalika Senggigi | for men</p>
        <p class="detail-desc-text">Senggigi terinspirasi dari ketenangan pantai Senggigi yang legendary. Aroma marine yang segar dan maskulin berpadu dengan cedarwood dan amber yang hangat, menciptakan wewangian versatile yang cocok untuk pria aktif.</p>
    </div>
