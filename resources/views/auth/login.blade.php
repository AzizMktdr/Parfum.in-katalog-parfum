...
<div class="auth-page">
    ...
    <div class="auth-form-side">
        ...
        <div class="auth-form-wrap">
            ...
            <div class="auth-errors" style="border-color:#2e7d32;background:#e8f5e9">
                <p class="auth-error-item" style="color:#2e7d32">{{ session('success') }}</p>
            </div>
            @endif
    ...
    <div class="auth-image-side">
        ...
        ╔══════════════════════════════════════════════════════╗
        ║  📁 GAMBAR LOGIN:                                    ║
        ║     public/images/auth/login-bg.jpg                  ║
        ║     Foto parfum dengan latar sunset/pink             ║
        ╚══════════════════════════════════════════════════════╝
        --}}
